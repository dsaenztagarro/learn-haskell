...
{-
    src/LanguageExtensions.Kinds.TypeLevelListOperations.hs:10:31: error:
    ...
    src/LanguageExtensions.Kinds.TypeLevelListOperations.hs:10:49: error:
        Unexpected kind variable ‘a’
        Perhaps you intended to use PolyKinds
        In the declaration for type family ‘Member’
       |
...
module LanguageExtensions.Kinds.TypeLevelListOperations.WithClosedTypeFamilies where
