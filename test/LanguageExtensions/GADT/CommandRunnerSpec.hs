...
module LanguageExtensions.GADT.CommandRunnerSpec (spec) where

import Test.Hspec
import LanguageExtensions.GADT.CommandRunner
import LanguageExtensions.GADT.ShellCmd
import LanguageExtensions.Helper
import Data.Proxy
