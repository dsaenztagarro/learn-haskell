...
module LanguageExtensions.Kinds.TypeLevelListOperations.WithClosedTypeFamiliesSpec where

import Test.Hspec
import LanguageExtensions.Kinds.TypeLevelListOperations.WithClosedTypeFamilies
import Data.Proxy
