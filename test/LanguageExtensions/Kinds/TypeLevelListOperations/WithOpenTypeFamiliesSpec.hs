...
module LanguageExtensions.Kinds.TypeLevelListOperations.WithOpenTypeFamiliesSpec where

import Test.Hspec
import LanguageExtensions.Kinds.TypeLevelListOperations.WithOpenTypeFamilies
import Data.Proxy
