module LanguageExtensions.Kinds.AssociatedTypeFamily.ShellCmdSpec (spec) where

import Test.Hspec
import LanguageExtensions.Kinds.AssociatedTypeFamily.ShellCmd
import System.FilePath ((</>))
import LanguageExtensions.Helper (withTestDir)
